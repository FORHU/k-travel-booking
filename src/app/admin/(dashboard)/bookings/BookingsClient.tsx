                    ...
                    {viewMode === 'list' ? (
                        ...
                        >
                            <div className="space-y-6">
                                ...
                                <div className="bg-white dark:bg-obsidian rounded-xl dark:border-white/5 relative transition-all duration-300 w-full overflow-hidden border border-slate-100 shadow-sm">
