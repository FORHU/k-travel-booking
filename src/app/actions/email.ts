...
/**
 * Server Action for sending booking confirmation emails.
 * Uses Resend API and logs to booking_emails table via service role key.
 */

import { createClient } from '@supabase/supabase-js';
import type { SendBookingEmailParams, SendBookingEmailResult } from './types';
