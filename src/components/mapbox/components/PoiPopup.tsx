...
export const PoiPopup = React.memo(({ poi, distance, onClose }: PoiPopupProps) => {
    ...
    return (
        ...
        >
            <div className="bg-white rounded-xl shadow-xl border border-slate-100 p-4 min-w-[240px] relative font-sans">
                ...
                <div className="flex items-center gap-2 mb-4 text-[12px] text-slate-600 font-medium tracking-tight">
                    <div className="flex items-center justify-center w-[22px] h-[22px] bg-slate-100 rounded-full flex-shrink-0">
                        <Navigation size={10} className="text-slate-700 transform rotate-45 ml-[-1px] mt-[-1px]" fill="currentColor" />
                    </div>
