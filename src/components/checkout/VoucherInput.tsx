...
export function VoucherInput({
    ...
    if (appliedVoucher) {
        return (
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-white/10 shadow-sm p-4 sm:p-5">
                <div className="flex items-center gap-2 mb-2 sm:mb-3">
                    <Tag size={16} className="text-blue-600 dark:text-blue-400 sm:w-4 sm:h-4 w-3.5 h-3.5" />
                    <h3 className="font-semibold text-slate-900 dark:text-white text-[13px] sm:text-sm">
                        Promo code
                    </h3>
                </div>
            ...
            <div className="flex gap-2">
                <div className="flex-1 relative min-w-0">
                    <input
                        ...
                        className={`w-full px-3 py-2 sm:py-2.5 text-[13px] sm:text-sm font-mono tracking-wider uppercase rounded-lg border transition-colors
                            ${voucherError
                ...
                <button
                    ...
                    className="px-4 py-2 sm:px-5 sm:py-2.5 text-[13px] sm:text-sm font-semibold rounded-lg transition-all whitespace-nowrap
