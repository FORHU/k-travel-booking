...
const AppBanner = () => {
  return (
    <section className="w-full py-4 md:py-8 lg:py-10 landscape-compact:py-2">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              >
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-6 mb-6">
                  <div>
                    <div className="text-xl sm:text-2xl font-mono font-bold text-white">10M+</div>
                    <div className="text-xs sm:text-sm text-white/60">Downloads</div>
                  </div>
                  <div>
                    <div className="text-xl sm:text-2xl font-mono font-bold text-white">4.9</div>
                    <div className="text-xs sm:text-sm text-white/60">App Rating</div>
                  </div>
                  <div>
                    <div className="text-xl sm:text-2xl font-mono font-bold text-white">15%</div>
                    <div className="text-xs sm:text-sm text-white/60">Extra Savings</div>
                  </div>
                </div>
