...
const Hero = () => {
    ...
    return (
        <section className="w-full flex flex-col items-center text-center max-w-4xl mx-auto mt-6 md:mt-10 lg:mt-16 mb-6 md:mb-10 lg:mb-16 landscape-compact:mt-2 landscape-compact:mb-2 relative px-4">
            {/* Background Glow */}
